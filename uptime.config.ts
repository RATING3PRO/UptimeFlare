...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/RATING3PRO', label: 'GitHub' },
    { link: 'https://www.xie.today/', label: 'Blog' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: 'BlogVercel',
      method: 'HEAD',
      target: 'https://www.xie.today/',
      statusPageLink: 'https://www.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'BlogEdgeone',
      method: 'HEAD',
      target: 'https://eocdnblog.xie.today/',
      statusPageLink: 'https://eocdnblog.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'BlogCloudflare',
      method: 'HEAD',
      target: 'https://cfcdnblog.xie.today/',
      statusPageLink: 'https://cfcdnblog.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'BlogNetlify',
      method: 'HEAD',
      target: 'https://nlcdnblog.xie.today/',
      statusPageLink: 'https://nlcdnblog.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Komari（Origin）',
      method: 'HEAD',
      target: 'https://koenv.xie.today/',
      statusPageLink: 'https://koenv.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Komari',
      method: 'HEAD',
      target: 'https://komari.xie.today/',
      statusPageLink: 'https://komari.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Alist（Origin）',
      method: 'GET',
      target: 'https://alist-origin.254301.xyz/',
      statusPageLink: 'https://alist-origin.254301.xyz/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Alist',
      method: 'HEAD',
      target: 'https://fileserver.xie.today/',
      statusPageLink: 'https://fileserver.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'R2（Origin）',
      method: 'HEAD',
      target: 'https://md.xie.today/',
      statusPageLink: 'https://md.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [404],
      timeout: 10000,
    },
    {
      ...
      name: 'R2',
      method: 'HEAD',
      target: 'https://r2pic.xie.today/',
      statusPageLink: 'https://r2pic.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [404],
      timeout: 10000,
    },
    {
      ...
      name: 'DoH Proxy',
      method: 'HEAD',
      target: 'https://cloudflare.doh.xie.today/',
    ...
    },
    {
      ...
      name: '短链接Worker',
      method: 'HEAD',
      target: 'https://n4.hk/c',
      statusPageLink: 'https://n4.hk/c',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Github Raw 代理',
      method: 'HEAD',
      target: 'https://gh.xie.today/',
      statusPageLink: 'https://gh.xie.today/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Cloudflare优选域名',
      method: 'HEAD',
      target: 'https://cf.254301.xyz/',
      statusPageLink: 'https://cf.254301.xyz/',
      hideLatencyChart: false,
      expectedCodes: [403],
      timeout: 10000,
    },
    {
      id: 'cf_best_ip_isp',
      name: 'Cloudflare优选域名三网优化',
      method: 'HEAD',
      target: 'https://isp.254301.xyz/',
      statusPageLink: 'https://isp.254301.xyz/',
      hideLatencyChart: false,
      expectedCodes: [403],
      timeout: 10000,
    },
  ...
  notification: {
    ...
    webhook: {
      ...
      payload: {
        "from": "系统状态更新 <uptimeflare@mailsend.xie.today>",
        "to": ["xiesmail2000@gmail.com"],
